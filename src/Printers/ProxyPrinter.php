...
final class ProxyPrinter
{
     ...
     */
    public function make(Declaration\Structure $structure, Declaration\DeclarationInterface $class, Declaration\DeclarationInterface $parent): string
    {
